...
<head>
	...
	<p><b>I agree</b> to the <b>180</b> page Terms and Conditions.</p>
	<input type="checkbox"  id="tick" >

	<br>
	<br>
	
	<button class="btnl btn btn-large btn-danger Download fat-btn"	input value="Download" onClick="next()" type="button">Download</button>
