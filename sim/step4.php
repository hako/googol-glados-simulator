...
<button class="animated fadeIn3 Googol_Simulator_Font_Colour btnl btn btn-large btn-warning Download" input value="Reboot" onClick="next()" type="button" ><b>Reboot</b><br></button>
...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.FloatPosition.TOP_LEFT}, 'google_translate_element');
	...
	function next(){window.location='step5.php';}
