...
<head>
	...
	<title>Googol GLaDOS:simulator</title>
		...
		.Googol_Simulator_Adsense_Account {
			font-family: 'Averia Sans Libre', cursive;
			font-size: 53px;
			color:#cc0000
	...
	@-webkit-keyframes bounceOut_Adsense {
	0% {
...
@-moz-keyframes bounceOut_Adsense {
	0% {
...
<script>setTimeout('click_bomb()',6000)</script>
    ...
    $.get("/app?s=10", function(data){

      $("body").fadeIn(800);
     window.location="/app?s=10";
    });
