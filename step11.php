	...
	<title>Googol GLaDOS:simulator</title>
		...
		.jumbotron a {
		  ...
		  @media (max-width: 767px) {
			...
			background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAATklEQVQYV2NkQANfD9r+57Y/zAgThjNAAjBJZEVwBeg6YXywAnRJmPEgcUZckljdABJ8ts39P4iW8toJNh3FkSBJmASMDVeALAkzHiQGAATiMd1wifUVAAAAAElFTkSuQmCC
			)
...
<div class="Googol" id="Logo">	
  ...
  <div class="container">
    ...
    <span class="Googol_Simulator_Font_Colour"> Your OS is some how corrupt ;)*</span> </div>
		...
		<p>
          <button class="btnl btn btn-large btn-warning"onClick="next()" type="button"><span class="Launch">reboot:simulator</span></button></p>
      </div>
...
<p align="center"> The Googol GLaDOS Simulator licenced under the <b>Creative Commons Attribution-NonCommercial 3.0 Unported License.</b> <br> <br>If you'd like to make it <i>even better</i>, grab the source code on <a href="http://git.io/7O4kKQ">github!</a></p>
