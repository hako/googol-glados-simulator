...
<h1 class="Three-Dee animated fadeInDown">404</h1>


<p class="animated fadeIn2">Oops. It looks like <b>YOU</b> stumbled accross another DEAD LINK. <b>Not Good.</b></p>


<p class="animated fadeIn3">Let me fix that for you...</p>


<p class="animated fadeIn4">Here you go. - GLaDOS.</p>

<button class="animated fadeIn4 Googol_Simulator_Font_Colour btnl btn btn-large btn-danger Download" input value="Back" onClick="next()" type="button" >Go Back<br></button>
