  ...
  <head>
    ...
    <style type="text/css">
     ...
     @import url(https://fonts.googleapis.com/css?family=Averia+Sans+Libre);
      ...
      /* Button 1 for last page */
    .btn-1-L {
      border: 3px solid #EBA716;
      color: #000000;
    }
...
<!-- Store the simulator for Offline use.-->
    ...
    <source src="img/ggs.mp4" type="video/mp4" />
    </video>
...
<div align="center">
        ...
        <h2 class="Googol_Simulator_Font_Colour"> Your OS is <i>"somehow"</i> corrupt ;)*</h2>
        <br>
  <p align="center"> <small>*well not really...</small></p>
        <p> Well I hope you enjoyed the simulator.</p>


        <p align="center" class="lead"> <small>Here's the <a href="http://www.youtube.com/watch?v=sDhc4mKtMkU">YouTube</a> video. or...</small></p><small> </small>

        <a href="/" class="btn btn-1-L btn-1a warning">reboot:simulator</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-md-offset-3 text-center">
            <center>
             <h1 class="icon-thumbsup white"></h1>
           </center>
                <h2 class="white">Credits &amp; Attributions</h2>
            <hr>
  ...
  <p align="center"> Constructed with Bootstrap 3.0.1 <a href="https://twitter.com/mdo">@mdo</a> &amp; <a href="https://twitter.com/fat">@fat</a></p>
          <p align="center"> HTML5 Audio processed by the loud and proud <b>howler.js</b></p>
          <p align="center"> Browser detection by <b>mobiledetect</b></p>
          <p align="center"> Powered by <b>Flight</b></p>
  ...
  <p align="center"> Icons by <b><a href="http://weloveiconfonts.com/">weloveiconfonts.com</a> and <a href="http://ionicons.com/">ionicons</a></b></p>
          <p align="center">   Built using <b>HTML5</b>, <b>Javascript</b> & PHP</p>
          <br>
          <h2> And finally...</h2>
          </div>
        </div>
