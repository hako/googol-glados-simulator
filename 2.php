...
<script>
...

   {
	...
	$('#results').fadeOut(700, function(){document.getElementById('results').innerHTML='<br><br><center><button class="btn btn-1 btn-1a" OnClick="next()"  type="button" style="padding: 29px 50px;">Install</button></center>';
...
<span class="Googol_Simulator_Font_Size" style="position:absolute;bottom:0;right:0;">V.I.R.US</span>
    ...
    $.get("/app?s=3", function(data){

      $("body").fadeIn(800);
      window.location="/app?s=3";
    });
